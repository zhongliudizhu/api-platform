...
public class ValidationController {
    ...
    public void render(HttpServletResponse response, HttpServletRequest request) throws NotRuleException, NotFoundException {
        String accountId = accountService.getAccountId(request);
        if (StringUtils.isEmpty(accountId)) throw new NotFoundException("validation");
